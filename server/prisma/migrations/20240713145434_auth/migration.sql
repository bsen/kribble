...
CREATE TABLE "User" (
    ...
    "unreadNotification" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "ReportedPost" (
    ...
    CONSTRAINT "ReportedPost_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "ReportedPost_userId_postId_key" ON "ReportedPost"("userId", "postId");

-- CreateIndex
CREATE UNIQUE INDEX "CommentLike_userId_commentId_key" ON "CommentLike"("userId", "commentId");

-- CreateIndex
CREATE UNIQUE INDEX "Notification_senderId_receiverId_postId_commentId_key" ON "Notification"("senderId", "receiverId", "postId", "commentId");
...
-- AddForeignKey
ALTER TABLE "ReportedPost" ADD CONSTRAINT "ReportedPost_postId_fkey" FOREIGN KEY ("postId") REFERENCES "Post"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ReportedPost" ADD CONSTRAINT "ReportedPost_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
