  ...
  return (
    <>
      <div className="flex bg-white flex-col justify-between h-screen border-r border-neutral-100">
        <div className="h-[45vh] flex px-6 flex-col justify-evenly items-center">
          ...
          <button
            ...
            className={`w-full h-10 px-4 rounded-lg bg-indigo-50 flex items-center justify-start gap-2 text-lg font-medium max-lg:hidden ${
          ...
          <button
            ...
            className={
              "w-full h-10 px-4 rounded-lg bg-indigo-500 text-white flex items-center justify-start gap-2 text-lg font-medium max-lg:hidden"
            }
          >
