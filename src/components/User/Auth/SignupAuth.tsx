      ...
      <div className="h-screen p-3 w-full md:w-[50%] flex justify-center items-center bg-indigomain">
        <div className="text-semilight text-center mb-4 font-ubuntu font-medium text-[2.5rem]">
          ...
          <div className="text-center text-sm font-thin mb-8 text-light">
            A place
Where college life meets limitless fun! 🎉 Share your moments, post cool pics, and dive into vibrant communities. With anonymous posting, let your thoughts soar freely. Conquer exciting challenges with CityMatch and join dynamic discussions with CityTalks. 🚀 Get ready to unleash the epicness – join us now!
          </div>
